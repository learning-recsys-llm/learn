...
![](./imgs/python-plugin.jpeg){ height=30% }
...
![](./imgs/mpe-plugin.jpeg){ height=30% }

### 终端

打开终端，在顶部的菜单里，点击『终端』->『新建终端』

![](./imgs/terminal.jpeg){ height=30% }
